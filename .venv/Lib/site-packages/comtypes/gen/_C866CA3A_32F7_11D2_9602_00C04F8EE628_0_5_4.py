...
__all__ = [
    'DISPID_SLPPartOfSpeech', 'DISPID_SRIsUISupported',
    'ISpeechRecognizerStatus', 'eLEXTYPE_PRIVATE15', 'SLODynamic',
    'SPEI_ADAPTATION', 'SINoSignal', 'SpeechStreamSeekPositionType',
    'SPAR_Medium', 'DISPID_SWFEChannels', 'DISPID_SRCRetainedAudio',
    'SPEI_MAX_TTS', 'SPAR_Low', 'SPDATAKEYLOCATION', 'SVF_Emphasis',
    'DISPID_SPIGetDisplayAttributes', 'SPSInterjection',
    'ISpeechFileStream', 'ISpeechMemoryStream', 'DISPID_SAStatus',
    'IInternetSecurityManager', 'ISpRecognizer3',
    'SpInProcRecoContext', 'ISpEventSink', 'DISPID_SRRPhraseInfo',
    'SPRULESTATE', 'DISPID_SPIRule', 'DISPID_SRAudioInput',
    'ISpXMLRecoResult', 'SpeechCategoryAppLexicons',
    'SAFTNonStandardFormat', 'DISPID_SRGRecoContext',
    'eLEXTYPE_PRIVATE20', 'SGSDisabled', 'ISpNotifySink',
    'DISPID_SDKSetLongValue', 'DISPID_SVAlertBoundary',
    'SpNullPhoneConverter', 'SpeechLoadOption', 'SVEStartInputStream',
    'ISpeechRecoResultTimes', 'DISPID_SMSAMMHandle', 'SVEPrivate',
    'STSF_LocalAppData', 'DISPID_SRCSetAdaptationData',
    'SAFT24kHz8BitStereo', 'SAFTCCITT_uLaw_22kHzStereo',
    'DISPID_SGRsCommitAndSave', 'DISPID_SpeechGrammarRules',
    'DISPID_SRGetRecognizers', 'DISPID_SFSClose',
    'DISPID_SGRSTWeight', 'SSFMOpenForRead', 'SVSFParseSapi',
    'SITooQuiet', 'SpLexicon', 'DISPID_SLWsCount', 'SPRECOSTATE',
    'SPWT_PRONUNCIATION', 'DISPID_SPPValue', 'SP_VISEME_2',
    'SPPHRASEPROPERTY', 'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SRProfile', 'SP_VISEME_14', 'SPCT_SLEEP', 'SPSMF_UPS',
    'SVSFIsFilename', 'tagSTATSTG', 'SREPhraseStart', 'SVP_6',
    'DISPID_SLWType', 'SAFTGSM610_44kHzMono', 'SSSPTRelativeToStart',
    'DISPID_SDKEnumKeys', 'SPEI_UNDEFINED',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'Speech_StreamPos_RealTime', 'ISpeechAudioBufferInfo',
    'SPXMLRESULTOPTIONS', 'SPSTREAMFORMATTYPE',
    'DISPID_SGRSTs_NewEnum', 'SREStateChange', 'DISPID_SpeechLexicon',
    'DISPID_SMSALineId', 'DISPID_SGRId', 'DISPID_SRGetPropertyNumber',
    'eLEXTYPE_PRIVATE2', 'SGLexical', 'SLOStatic', 'SPPHRASE',
    'DISPID_SPARecoResult', 'SAFTGSM610_11kHzMono',
    'DISPID_SVSRunningState', 'SpeechDisplayAttributes',
    'ISpeechPhraseReplacement', 'DISPID_SABIMinNotification',
    'DISPID_SPISaveToMemory', 'DISPID_SGRsFindRule',
    'DISPID_SVDisplayUI', 'SPWT_LEXICAL', 'SPVPRI_NORMAL',
    'SAFTGSM610_22kHzMono', 'SGRSTTDictation', 'DISPID_SBSSeek',
    'DISPID_SGRSTNextState', 'SP_VISEME_17', 'DISPID_SRCEAudioLevel',
    'eLEXTYPE_PRIVATE8', 'DISPID_SpeechObjectTokens',
    'SPPS_SuppressWord', 'SGDisplay', 'SpeechMicTraining',
    'DISPID_SVGetAudioInputs', 'SPEVENT', 'eLEXTYPE_VENDORLEXICON',
    'SAFT11kHz16BitMono', 'eLEXTYPE_PRIVATE12', 'SAFT16kHz16BitMono',
    'SAFT12kHz8BitMono', 'SREBookmark', 'SRAExport',
    'SPPS_Noncontent', 'SAFT8kHz16BitMono', 'SRCS_Disabled',
    'SSFMOpenReadWrite', 'DISPID_SRRSpeakAudio',
    'ISpeechGrammarRuleStateTransition',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SPACommit', 'DISPIDSPTSI', 'SpSharedRecognizer',
    'DISPID_SGRAddResource', 'DISPID_SPRuleName', 'SVP_14',
    ...
    'SpeechTokenValueCLSID', 'SPPS_Interjection',
    'SAFTCCITT_ALaw_11kHzStereo', 'ISpGrammarBuilder',
    'DISPID_SAEventHandle', 'SpMMAudioIn', 'SDTAlternates',
    'eLEXTYPE_PRIVATE7', 'DISPID_SRRecognizer', 'DISPID_SPRuleParent',
    'SpeechCategoryAudioIn', 'DISPID_SGRSTPropertyValue',
    'ISpeechRecoGrammar', 'ISpeechRecoResult',
    'DISPID_SRRTStreamTime', 'SPSHT_OTHER', 'eLEXTYPE_PRIVATE19',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SRSAudioStatus', 'SGSEnabled', 'SREInterference',
    'DISPID_SASState', 'SPAS_STOP', 'ISpeechPhraseElement',
    'DISPID_SWFEFormatTag', 'SPEI_SR_BOOKMARK', 'SRSEIsSpeaking',
    'SPSERIALIZEDRESULT', 'SpPhoneConverter', 'SPINTERFERENCE',
    'SPGS_EXCLUSIVE', 'DISPID_SRGetPropertyString', 'DISPID_SVVolume',
    'SP_VISEME_10', 'SVP_9', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPID_SBSFormat', 'STCInprocServer',
    'DISPID_SRCERecognizerStateChange', 'SpeechAllElements',
    'SPCT_DICTATION', 'SpWaveFormatEx',
    'DISPID_SPERequiredConfidence', 'SpUnCompressedLexicon',
    'SPFM_OPEN_READWRITE', 'SVSFParseMask', 'SVP_15',
    'SAFTExtendedAudioFormat', 'DISPID_SPIStartTime',
    'DISPID_SMSSetData', 'SPAS_PAUSE', 'SVSFPurgeBeforeSpeak',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SLGetWords',
    'SP_VISEME_12', 'SPINTERFERENCE_NONE', 'IEnumSpObjectTokens',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SPIRetainedSizeBytes',
    'DISPID_SVSLastResult', 'SPEI_INTERFERENCE',
    'SPINTERFERENCE_NOISE', 'DISPID_SPEs_NewEnum', 'SpeechRunState',
    'DISPID_SCSBaseStream', 'eLEXTYPE_PRIVATE18',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'DISPID_SVEAudioLevel',
    'DISPID_SRCESoundEnd', 'SVP_8', 'IStream',
    'DISPID_SWFESamplesPerSec', 'SPSNoun', 'SPVPRI_OVER',
    'DISPID_SPAPhraseInfo', 'Speech_Max_Pron_Length',
    'DISPID_SOTCEnumerateTokens', 'ISpRecognizer2',
    'SAFT44kHz8BitStereo', 'SpeechAudioVolume',
    'DISPID_SpeechObjectToken', 'DISPID_SVResume',
    'DISPID_SOTDataKey', 'DISPID_SAFType',
    'DISPID_SASCurrentDevicePosition', 'SpeechUserTraining',
    'DISPID_SPIAudioStreamPosition', 'SGDSInactive',
    'SPRST_NUM_STATES', 'DISPID_SPEEngineConfidence',
    'SGDSActiveWithAutoPause', 'DISPID_SPEDisplayAttributes',
    'DISPID_SPRsCount', 'ISpSerializeState',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SpeechPhraseProperties',
    'DISPID_SPRuleChildren', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SRRAlternates', 'ISpeechRecoResult2',
    'DISPID_SVIsUISupported', 'SpPhoneticAlphabetConverter',
    'DISPID_SOTGetDescription', 'ISpeechRecoContext',
    'DISPID_SPIGrammarId', 'SAFTCCITT_uLaw_8kHzMono',
    'SpeechBookmarkOptions', 'SASClosed', 'DISPID_SpeechPhraseRule',
    'SAFT16kHz16BitStereo', 'STSF_CommonAppData', 'SRARoot',
    'SPPS_Verb', 'DISPID_SDKGetBinaryValue',
    'DISPID_SpeechPhraseAlternate', 'SPBO_TIME_UNITS',
    'SPXRO_Alternates_SML', 'SpeechRecoProfileProperties',
    'eLEXTYPE_PRIVATE16', 'DISPID_SPIEnginePrivateData',
    'DISPID_SpeechRecoContext', 'ISpLexicon',
    'DISPID_SRRSetTextFeedback', 'SVEBookmark', 'SpeechTokenKeyUI',
    'SVSFUnusedFlags', 'DISPID_SVAudioOutputStream',
    'SpeechTokenContext', 'SRESoundStart', 'SDTAudio',
    'ISpeechPhraseRules', 'SPAS_CLOSED', 'SAFT24kHz16BitStereo',
    'DISPID_SLGetGenerationChange', 'DISPID_SVRate',
    'DISPID_SVSPhonemeId', 'SPFM_CREATE_ALWAYS', 'SVP_1',
    'ISpRecoGrammar2', 'DISPID_SpeechPhraseReplacement',
    'DISPID_SLPLangId', 'DISPID_SPAStartElementInResult', 'SPRULE',
    'SP_VISEME_6', 'DISPID_SPPChildren', 'SDA_Consume_Leading_Spaces',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SpeechTokenKeyFiles',
    'ISpeechVoiceStatus', 'DISPID_SRGCmdLoadFromResource',
    'DISPID_SRGState', 'eLEXTYPE_RESERVED9', 'SREAdaptation',
    'DISPID_SRIsShared', 'SPVPRIORITY', 'SGRSTTEpsilon', 'SPWORDLIST',
    'SPSVerb', 'ISpProperties', 'DISPID_SPIEngineId',
    'SPAUDIOOPTIONS', 'SVSFDefault', 'SSFMCreate', 'SDTProperty',
    'SPCT_SUB_DICTATION', 'SpeechVoicePriority', 'SP_VISEME_0',
    'SpeechRetainedAudioOptions', 'ISpeechVoice',
    'DISPID_SpeechRecoResult', 'ISpeechCustomStream',
    'SWPKnownWordPronounceable', 'SpeechPropertyAdaptationOn',
    'ISpPhraseAlt', 'DISPID_SpeechPhraseReplacements',
    'ISpStreamFormat', '__MIDL_IWinTypes_0009',
    'DISPID_SDKGetStringValue', 'SP_VISEME_13',
    'DISPID_SPRuleFirstElement', 'DISPID_SRDisplayUI',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SVSpeakStream',
    '_ISpeechRecoContextEvents', 'SpeechCategoryRecognizers',
    'SAFT16kHz8BitStereo', 'SpTextSelectionInformation',
    'SPRS_ACTIVE_USER_DELIMITED', 'ISpeechAudioStatus',
    'DISPID_SpeechRecoResult2', 'DISPID_SABufferInfo',
    'SAFTADPCM_44kHzMono', 'DISPID_SLPs_NewEnum', 'SP_VISEME_7',
    'SPGRAMMARWORDTYPE', 'DISPID_SPIReplacements',
    'DISPID_SOTCreateInstance', 'SAFT11kHz16BitStereo',
    'SPRST_ACTIVE_ALWAYS', 'SBONone', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SpeechAudioFormat', 'SECLowConfidence', 'SPEI_HYPOTHESIS',
    'DISPID_SpeechPhraseInfo', 'eLEXTYPE_PRIVATE11',
    'SPRECOGNIZERSTATUS', 'DISPID_SRRRecoContext',
    'SpInprocRecognizer', 'SAFTADPCM_11kHzMono', 'SPAR_Unknown',
    'eLEXTYPE_RESERVED6', 'DISPID_SRRTimes', 'SPSEMANTICERRORINFO',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SRCCreateResultFromMemory',
    'SWTDeleted', 'DISPID_SRCEPropertyStringChange',
    'SECHighConfidence', 'SP_VISEME_11', 'ISpStreamFormatConverter',
    'SECFIgnoreCase', 'SpeechVoiceSpeakFlags',
    'SpeechVoiceCategoryTTSRate', 'SRADefaultToActive',
    'eLEXTYPE_PRIVATE4', 'SVEAllEvents', 'SPEI_TTS_BOOKMARK',
    'SAFTADPCM_22kHzMono', 'DISPID_SPRulesItem', 'SDKLLocalMachine',
    'ISpeechWaveFormatEx', 'SPRST_ACTIVE', 'SpeechRuleAttributes',
    'ISpPhoneticAlphabetConverter', 'eLEXTYPE_MORPHOLOGY',
    'SVEAudioLevel', 'DISPID_SREmulateRecognition', 'SPCT_COMMAND',
    'SREStreamEnd', 'DISPID_SVVoice', 'SpeechRecognizerState',
    'SPPS_LMA', 'DISPID_SVSpeak', 'DISPID_SRCreateRecoContext',
    'DISPID_SVESentenceBoundary', 'SpeechLexiconType',
    'DISPID_SPERetainedStreamOffset', 'SGRSTTWildcard',
    'DISPID_SPRs_NewEnum', 'SPEI_START_SR_STREAM', 'DISPID_SVPause',
    'SPFM_NUM_MODES', 'ISpeechObjectToken', 'ISpeechPhraseAlternate',
    'SREPropertyNumChange', 'DISPID_SRSetPropertyNumber',
    'SGSExclusive', 'DISPID_SRSCurrentStreamPosition',
    'DISPID_SRSCurrentStreamNumber', 'SpMMAudioOut',
    'DISPID_SRGCmdLoadFromMemory', 'SRERecognition', 'SPPS_RESERVED1',
    'ISpObjectWithToken', 'SAFT22kHz16BitStereo',
    'ISpeechTextSelectionInformation', 'SFTSREngine',
    'DISPID_SpeechMemoryStream', 'SRCS_Enabled', 'SVP_17',
    'DISPID_SASetState', 'SECFIgnoreKanaType',
    'DISPID_SRGIsPronounceable', 'SPEI_SENTENCE_BOUNDARY',
    'SAFT22kHz8BitMono', 'SPWORDPRONUNCIATIONLIST',
    'DISPIDSPTSI_SelectionOffset', 'SVP_18', 'STCLocalServer',
    'STCRemoteServer', 'DISPID_SPPsItem', 'SPEI_SOUND_START',
    'SPWAVEFORMATTYPE', 'ISpeechPhraseInfo', 'SpeechStreamFileMode',
    'eLEXTYPE_PRIVATE13', 'SRSEDone', 'SPBO_AHEAD',
    'ISpeechResourceLoader', 'DISPID_SpeechGrammarRuleState',
    'SITooFast', 'SpeechRecoContextState', 'DISPID_SGRSTPropertyName',
    'SpeechPropertyHighConfidenceThreshold', 'ISpRecoGrammar',
    'DISPID_SBSWrite', 'ISpeechLexiconPronunciations',
    'SPPS_NotOverriden', 'SPCS_DISABLED',
    'SpeechPropertyComplexResponseSpeed', 'SPPARTOFSPEECH',
    'SVPAlert', 'DISPID_SRGDictationUnload', 'SP_VISEME_5',
    'SECFNoSpecialChars', 'SPRECOCONTEXTSTATUS', 'SAFT16kHz8BitMono',
    'DISPID_SVSLastBookmark', 'eLEXTYPE_RESERVED7', 'SpeechRuleState',
    'SpeechCategoryPhoneConverters', 'SpeechGrammarWordType',
    'SAFT48kHz16BitStereo', 'SPPROPERTYINFO', 'SPEI_MIN_SR',
    'SGRSTTTextBuffer', 'SPPHRASEELEMENT', 'SPSLMA',
    'DISPID_SLWLangId', 'SPEI_RESERVED3', 'SVSFlagsAsync',
    'ISpObjectTokenCategory', 'DISPID_SVGetAudioOutputs',
    'SPSHORTCUTPAIRLIST', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SVEventInterests', 'DISPID_SPEAudioSizeTime', 'SLTUser',
    'DISPID_SpeechBaseStream', 'SAFTADPCM_11kHzStereo',
    'Speech_Max_Word_Length', 'DISPID_SPPNumberOfElements',
    'DISPID_SGRSTType', 'DISPID_SPPsCount', 'SGRSTTWord',
    'SPADAPTATIONRELEVANCE',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SPPS_RESERVED3',
    'SAFTGSM610_8kHzMono', 'SVESentenceBoundary', 'SVF_Stressed',
    'SPGS_DISABLED', 'DISPID_SDKEnumValues', 'DISPID_SOTDisplayUI',
    'DISPID_SPEActualConfidence', 'DISPID_SPEAudioTimeOffset',
    'DISPID_SPRuleConfidence', 'SPEI_VISEME', 'SPLOADOPTIONS',
    'SAFTTrueSpeech_8kHz1BitMono', 'SpeechRegistryLocalMachineRoot',
    'DISPID_SpeechPhraseRules', 'SPEI_END_SR_STREAM',
    'SVSFPersistXML', 'SPPS_Noun', 'DISPID_SRGRules',
    'SPSSuppressWord', 'DISPID_SABIEventBias', 'eWORDTYPE_DELETED',
    'SPSUnknown', 'SVP_12', 'ISpResourceManager', 'ISpeechLexicon',
    'ISpPhoneConverter', '_ISpeechVoiceEvents', 'SDTDisplayText',
    'SPPS_Modifier', 'DISPID_SRCERequestUI',
    'SpeechGrammarTagDictation', 'SPEI_RESERVED2',
    'DISPID_SGRSTPropertyId', 'DISPID_SOTCId', 'SDTPronunciation',
    'DISPID_SABufferNotifySize', 'SRESoundEnd',
    'DISPID_SRCEEnginePrivate', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SLWWord', 'SpeechAddRemoveWord',
    'SPEI_RECO_OTHER_CONTEXT', 'ISpeechPhraseAlternates',
    'DISPID_SPRules_NewEnum', 'DISPID_SRCRecognizer',
    '_RemotableHandle', 'ISpeechPhraseElements', 'SpeechAudioState',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SRCState',
    'DISPID_SRCAudioInInterferenceStatus', 'DISPID_SGRsCount',
    'SAFT44kHz8BitMono', 'DISPID_SRGDictationSetState',
    'ISpMMSysAudio', 'ISpeechMMSysAudio',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SOTGetAttribute',
    'DISPID_SWFEBlockAlign', 'SpNotifyTranslator',
    'SPDKL_CurrentConfig', 'ISpeechDataKey',
    'IInternetSecurityMgrSite', 'SREPrivate',
    'DISPID_SADefaultFormat', 'DISPID_SGRsItem', 'DISPID_SGRSTText',
    'ISpRecoContext2', 'SAFT11kHz8BitMono', 'STCAll',
    'SPAUDIOBUFFERINFO', 'SP_VISEME_16', 'SpeechDiscardType',
    'DISPID_SPPParent', 'SINone', 'SAFT32kHz16BitMono',
    'SAFTADPCM_44kHzStereo', 'SGDSActive',
    'DISPID_SpeechLexiconWords', 'IEnumString', 'SDTLexicalForm',
    'SpeechTokenIdUserLexicon', 'SPEI_TTS_PRIVATE',
    'SpeechGrammarTagWildcard', 'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SAVolume', 'ISpRecoContext', 'SpCompressedLexicon',
    'SPEI_PROPERTY_NUM_CHANGE', 'SAFTADPCM_8kHzStereo',
    'SPEI_PHONEME', 'SPDKL_DefaultLocation',
    'SpeechAudioFormatGUIDText', 'DISPID_SPPId',
    'SAFTADPCM_22kHzStereo', 'SPEVENTSOURCEINFO',
    'DISPID_SpeechLexiconPronunciation', 'SPEI_SOUND_END',
    'DISPID_SPEPronunciation', 'SPAS_RUN', 'DISPID_SASNonBlockingIO',
    'DISPID_SRCEStartStream', 'ISpRecoResult',
    'ISpeechPhraseReplacements', 'DISPID_SLAddPronunciation',
    'DISPID_SLWsItem', 'DISPID_SGRSAddWordTransition', 'SVEPhoneme',
    'SPEI_RESERVED1', 'ISpeechObjectTokenCategory',
    'DISPID_SpeechRecognizer', 'DISPID_SpeechVoiceEvent',
    'DISPID_SOTRemove', 'SP_VISEME_3', 'DISPIDSPTSI_SelectionLength',
    'SSSPTRelativeToEnd', 'SREStreamStart', 'SPTEXTSELECTIONINFO',
    'SAFT32kHz8BitMono', 'DISPID_SVSInputWordLength',
    'SREFalseRecognition', 'SRERequestUI', 'SP_VISEME_4',
    'SPFILEMODE', 'DISPIDSPTSI_ActiveOffset',
    'DISPID_SPIAudioSizeBytes', 'SRTEmulated', 'DISPID_SLWs_NewEnum',
    'SPWORDPRONOUNCEABLE', 'SVP_11', 'DISPID_SBSRead',
    'DISPID_SRCPause', 'tagSPPROPERTYINFO', 'SPBO_PAUSE',
    'DISPID_SVSLastStreamNumberQueued', 'SAFT8kHz16BitStereo',
    'ISpRecoCategory', 'ISpPhrase', 'SP_VISEME_19',
    'DISPID_SOTIsUISupported', 'SpPhraseInfoBuilder',
    'DISPID_SGRInitialState', 'SGDSActiveUserDelimited',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SVSFIsNotXML', 'SVSFParseSsml',
    'DISPID_SVSInputWordPosition', 'SpeechWordPronounceable',
    'DISPID_SOTCategory', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SGRSRule', 'DISPID_SGRsCommit', 'SPCS_ENABLED',
    'DISPID_SLGenerationId', 'DISPID_SOTsCount',
    'ISpeechXMLRecoResult', 'SpeechGrammarState',
    'SAFTCCITT_uLaw_8kHzStereo', 'SPFM_CREATE', 'DISPID_SOTsItem',
    'DISPID_SOTSetId', 'DISPID_SpeechRecoContextEvents',
    'SDA_Two_Trailing_Spaces', 'SAFT22kHz8BitStereo',
    'SAFT48kHz16BitMono', 'DISPID_SpeechPhraseElement',
    'eLEXTYPE_PRIVATE14', 'DISPID_SOTCGetDataKey',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SPSModifier',
    'SPVPRI_ALERT', 'SPGS_ENABLED', 'ISpStream', 'DISPID_SVEViseme',
    'SPINTERFERENCE_TOOFAST', 'DISPID_SAFGuid',
    'SpeechTokenShellFolder', 'DISPID_SLPsItem',
    'tagSPTEXTSELECTIONINFO', 'eLEXTYPE_RESERVED10', 'SPXRO_SML',
    'SPSERIALIZEDPHRASE', 'DISPID_SRGCommit',
    'SWPUnknownWordUnpronounceable', 'SSTTWildcard',
    'DISPID_SRGDictationLoad', 'SVP_2', 'DISPID_SGRClear',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SpeechGrammarRule',
    'SPEI_VOICE_CHANGE', 'SpeechCategoryVoices',
    'DISPID_SPPFirstElement', 'DISPID_SLPSymbolic',
    'DISPID_SLWPronunciations', 'SAFT48kHz8BitMono',
    'DISPID_SPPConfidence', 'SRTSMLTimeout', 'DISPID_SRSClsidEngine',
    'SpAudioFormat', 'DISPID_SpeechPhraseProperty',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SpeechVoiceStatus',
    'DISPID_SGRs_NewEnum', 'SpeechAudioFormatType',
    'DISPID_SpeechXMLRecoResult', 'SDKLCurrentUser',
    'DISPID_SRCVoice', 'SAFT12kHz8BitStereo', 'DISPID_SPAs_NewEnum',
    'DISPID_SVSVisemeId', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SVSInputSentenceLength', '_SPAUDIOSTATE',
    'SAFT32kHz8BitStereo', 'SAFT44kHz16BitStereo', 'SVP_19',
    'eLEXTYPE_USER', 'SPRST_INACTIVE_WITH_PURGE', 'ISpeechAudio',
    'SREAudioLevel', 'DISPID_SRRAudioFormat', 'SVPOver',
    'SPEI_RECO_STATE_CHANGE', 'SRSActive', 'ISpVoice',
    'DISPID_SPRNumberOfElements', 'SpeechDictationTopicSpelling',
    'SpeechGrammarRuleStateTransitionType',
    'DISPID_SDKSetStringValue', 'eLEXTYPE_APP', 'SRAONone',
    'SpResourceManager', 'DISPID_SPERetainedSizeBytes',
    'SECFEmulateResult', 'eLEXTYPE_RESERVED4', 'DISPID_SGRAttributes',
    'SpeechCategoryAudioOut', 'SpeechVoiceSkipTypeSentence',
    'SAFTCCITT_uLaw_11kHzMono', 'ISpeechObjectTokens',
    'SAFT24kHz8BitMono', 'SAFT48kHz8BitStereo', 'SPWF_SRENGINE',
    'SpeechEngineConfidence', 'SPWF_INPUT', 'SpeechVisemeFeature',
    'SGLexicalNoSpecialChars', 'SREHypothesis', 'SVP_3',
    'SpeechEngineProperties', 'ISpeechGrammarRuleState',
    'SAFT8kHz8BitMono', 'DISPID_SVEWord', 'DISPID_SVSkip', 'SDTAll',
    'DISPID_SDKOpenKey', 'SPINTERFERENCE_TOOLOUD',
    'SECNormalConfidence', 'DISPID_SVEStreamStart',
    'DISPID_SVEEnginePrivate', 'eLEXTYPE_PRIVATE6', 'SRAORetainAudio',
    'eWORDTYPE_ADDED', 'DISPID_SRCERecognitionForOtherContext',
    'SpeechPropertyResourceUsage', 'SPSHORTCUTPAIR',
    'SAFTCCITT_ALaw_44kHzMono', 'DISPID_SLGetPronunciations',
    'eLEXTYPE_PRIVATE9', 'SSFMCreateForWrite', 'SRTReSent',
    'SPEI_TTS_AUDIO_LEVEL', 'SVP_16', 'SDA_No_Trailing_Space',
    'DISPID_SRRSaveToMemory', 'DISPID_SpeechPhoneConverter',
    'DISPID_SVSInputSentencePosition', 'DISPID_SRCRequestedUIType',
    'DISPID_SGRsAdd', 'eLEXTYPE_PRIVATE1', 'DISPID_SVGetVoices',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SpStream',
    'SpObjectToken', 'SPCONTEXTSTATE', 'SpeechEmulationCompareFlags',
    'SPPHRASEREPLACEMENT', 'SVP_5', 'DISPID_SPEAudioStreamOffset',
    'SRTAutopause', 'SAFTDefault', 'DISPID_SPCIdToPhone',
    'DISPID_SRGId', 'DISPID_SRRTTickCount', 'DISPID_SGRsDynamic',
    'eLEXTYPE_PRIVATE17', 'SpeechSpecialTransitionType',
    'ISpeechLexiconWord', 'SPBINARYGRAMMAR', 'WAVEFORMATEX',
    'DISPID_SVGetProfiles', 'eLEXTYPE_PRIVATE3',
    'DISPIDSPTSI_ActiveLength', 'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SPEsItem', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SPEI_MIN_TTS', 'DISPID_SOTCDefault',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SRCEInterference',
    'SPCT_SUB_COMMAND', 'SVSFNLPSpeakPunc', 'SPSHT_Unknown',
    'DISPID_SOTMatchesAttributes', 'DISPID_SRRGetXMLResult',
    'SPAUDIOSTATE', 'SVEEndInputStream',
    ...
    'DISPID_SGRSTsItem', 'DISPID_SPPs_NewEnum',
    'DISPID_SLRemovePronunciation', 'SPEI_RESERVED6',
    'DISPID_SLAddPronunciationByPhoneIds', 'ISpeechBaseStream',
    'SITooSlow', 'DISPID_SpeechAudioStatus',
    'SAFTCCITT_uLaw_11kHzStereo', 'SASPause', 'SITooLoud',
    'SAFTCCITT_ALaw_8kHzMono', 'SPWORDTYPE',
    'SpeechCategoryRecoProfiles', 'DISPID_SRSNumberOfActiveRules',
    'SRSInactive', 'SPBO_NONE', 'DISPID_SpeechPhraseElements',
    'DISPID_SRCEEndStream', 'eLEXTYPE_RESERVED8',
    'DISPID_SRGetFormat', 'SREAllEvents', 'SPLO_STATIC',
    'DISPID_SRStatus', 'DISPID_SPCLangId', 'DISPID_SPRulesCount',
    'SVSFVoiceMask', 'SPRS_ACTIVE', 'DISPID_SWFEAvgBytesPerSec',
    'SPEI_RECOGNITION', 'SAFT12kHz16BitStereo', 'ISpNotifySource',
    'DISPID_SPIGetText', 'DISPID_SABIBufferSize', 'SPAO_RETAIN_AUDIO',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SRCCmdMaxAlternates',
    'DISPID_SVAudioOutput', 'DISPID_SRSSupportedLanguages',
    'ISpeechGrammarRuleStateTransitions',
    'DISPID_SRGSetWordSequenceData', 'SpeechVoiceEvents',
    'SGRSTTRule', 'SWPUnknownWordPronounceable', 'LONG_PTR',
    'ISpNotifyTranslator', 'SVEVoiceChange', 'SRTExtendableParse',
    'ISpRecognizer', 'DISPID_SPEsCount', 'DISPID_SpeechMMSysAudio',
    'DISPID_SRRTLength', 'DISPID_SDKCreateKey', 'DISPID_SRGReset',
    'DISPID_SWFEBitsPerSample', 'DISPID_SVPriority', 'SWTAdded',
    'DISPID_SLPsCount', 'SASStop', 'DISPID_SpeechObjectTokenCategory',
    'ISpeechRecognizer', 'SPPS_RESERVED2', 'SPDKL_LocalMachine',
    'SAFTNoAssignedFormat', 'DISPID_SRCEHypothesis', 'SP_VISEME_15',
    'SP_VISEME_9', 'SVSFNLPMask', 'DISPID_SDKSetBinaryValue',
    'DISPID_SGRAddState', 'SPPS_Function', 'SVF_None',
    'ISpeechRecoResultDispatch', 'SPWT_DISPLAY',
    'DISPID_SPILanguageId', 'DISPID_SPRsItem', 'SpSharedRecoContext',
    'ISpeechPhraseProperties', 'DISPID_SOTs_NewEnum', 'SPAR_High',
    'SDTRule', 'SPEI_END_INPUT_STREAM', 'SPAO_NONE', 'SPPHRASERULE',
    'DISPID_SGRName', 'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SPEVENTENUM',
    'DISPID_SRAudioInputStream', 'SpeechVisemeType', 'SPPS_Unknown',
    'ISpDataKey', 'DISPID_SpeechVoice', 'DISPID_SpeechCustomStream',
    'SPEI_PHRASE_START', 'SPLO_DYNAMIC', 'DISPID_SRRGetXMLErrorInfo',
    'ISpObjectToken', 'SPEI_SR_AUDIO_LEVEL', 'DISPID_SVEVoiceChange',
    'SPWORDPRONUNCIATION', 'SPCATEGORYTYPE',
    'DISPID_SRCEPropertyNumberChange', 'SAFT12kHz16BitMono',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'STCInprocHandler',
    'SpeechPropertyNormalConfidenceThreshold', 'ISpAudio', 'SVP_21',
    'DISPID_SFSOpen', 'SRAInterpreter', 'DISPID_SRCBookmark',
    'SRADynamic', 'DISPID_SRGCmdLoadFromFile',
    'DISPID_SPEDisplayText', 'SDKLCurrentConfig',
    'DISPID_SPELexicalForm', 'SPINTERFERENCE_TOOSLOW',
    'SRERecoOtherContext', 'SpeechRecognitionType',
    'DISPID_SPAsCount', 'SpeechPartOfSpeech', 'DISPID_SRCResume',
    'DISPID_SPAsItem', 'ISpPhoneticAlphabetSelection',
    'DISPID_SRCCreateGrammar', 'DISPID_SPRuleNumberOfElements',
    'SpShortcut', 'UINT_PTR', 'STSF_AppData',
    'SAFTCCITT_ALaw_11kHzMono', 'SP_VISEME_8', 'DISPIDSPRG',
    'DISPID_SpeechAudioBufferInfo', 'SPEI_RESERVED5',
    'SPPS_RESERVED4', 'SP_VISEME_20', 'SpeechRecoEvents', 'SPWORD',
    'SpeechFormatType', 'DISPID_SVSpeakCompleteEvent',
    'SPEI_SR_RETAINEDAUDIO', 'DISPID_SLPPhoneIds', 'SVSFIsXML',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SpeechDataKey',
    'SAFTText', 'DISPID_SPRFirstElement', 'DISPID_SMSADeviceId',
    'DISPID_SRCEFalseRecognition', 'SpVoice', 'DISPID_SPPName',
    ...
    'DISPID_SRGCmdSetRuleState', 'SLTApp', 'SPDKL_CurrentUser',
    'SPLEXICONTYPE', 'DISPID_SPRDisplayAttributes',
    'SpeechRegistryUserRoot', 'SpMemoryStream', 'SVSFParseAutodetect',
    'DISPID_SVSLastBookmarkId', 'SAFT8kHz8BitStereo',
    'SAFT44kHz16BitMono', 'SVP_0', 'DISPID_SRGCmdSetRuleIdState',
    'SPRST_INACTIVE', 'SSTTDictation', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SPIAudioSizeTime', 'SASRun', 'SRSInactiveWithPurge',
    'ISpeechPhraseProperty', 'DISPID_SVWaitUntilDone', 'SP_VISEME_1',
    'ISpeechPhraseRule', 'SpObjectTokenCategory', 'SFTInput',
    'DISPID_SOTId', 'ISpShortcut', 'DISPID_SpeechFileStream',
    'SPSHT_NotOverriden', 'DISPID_SPRuleEngineConfidence',
    'DISPID_SpeechLexiconProns', 'eLEXTYPE_PRIVATE10',
    'SAFTADPCM_8kHzMono', 'SpeechAudioProperties', 'SVP_20',
    'SSTTTextBuffer', 'SDTReplacement', 'SAFT22kHz16BitMono',
    'DISPID_SWFEExtraData', 'SpeechPropertyResponseSpeed',
    'DISPID_SDKDeleteValue', 'SAFT24kHz16BitMono', 'SVP_4', 'SVP_7',
    'DISPID_SOTGetStorageFileName', 'DISPID_SpeechAudio',
    'DISPID_SPIProperties', 'SPSHORTCUTTYPE', 'SRAImport',
    'SREPropertyStringChange', 'SpeechTokenKeyAttributes',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SRCVoicePurgeEvent',
    'DISPID_SRCEBookmark', 'SPINTERFERENCE_NOSIGNAL',
    'DISPID_SGRSTsCount', 'DISPID_SRState', 'SpMMAudioEnum',
    'SVEWordBoundary', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'STSF_FlagCreate', 'DISPID_SPRuleId', 'DISPID_SpeechLexiconWord',
    'Speech_StreamPos_Asap', 'DISPID_SRCEventInterests',
    'DISPID_SRCESoundStart', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SRCEAdaptation', 'DISPID_SVEStreamEnd',
    'SPEI_START_INPUT_STREAM', 'ISpEventSource',
    'SDKLDefaultLocation', 'ISpeechGrammarRules',
    'eLEXTYPE_USER_SHORTCUT', 'ISpeechAudioFormat',
    'DISPID_SDKDeleteKey', 'SRSActiveAlways', 'SpeechInterference',
    'DISPID_SLPType', 'SVP_10', 'SPSHT_EMAIL',
    'SpStreamFormatConverter',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'DISPID_SGRSTRule',
    'SPVOICESTATUS', 'SVP_13', 'DISPID_SOTCSetId',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SVEPhoneme', 'SVPNormal',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SVStatus', 'SVEViseme',
    'SpeechWordType', 'DISPID_SAFGetWaveFormatEx',
    'SPSMF_SAPI_PROPERTIES', 'ISpeechGrammarRule', 'SPSEMANTICFORMAT',
    'SPRECORESULTTIMES', 'SpeechDataKeyLocation',
    'ISpeechPhoneConverter', 'ISequentialStream', 'SpCustomStream',
    'SAFTCCITT_ALaw_44kHzStereo', 'ISpeechPhraseInfoBuilder',
    'SPEI_REQUEST_UI', 'SPFM_OPEN_READONLY', 'SPSFunction',
    'DISPID_SPANumberOfElementsInResult', 'SBOPause',
    'eLEXTYPE_PRIVATE5', 'Speech_Default_Weight', 'SPVISEMES',
    'eLEXTYPE_LETTERTOSOUND', 'DISPID_SRSetPropertyString',
    'SpFileStream', 'DISPID_SDKGetlongValue', 'ISpeechLexiconWords',
    'ISpeechLexiconPronunciation', 'SPEI_SR_PRIVATE',
    'SPEI_WORD_BOUNDARY', 'SPRS_INACTIVE', 'SPSNotOverriden',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SPAUDIOSTATUS', 'SPEI_MAX_SR',
    'DISPID_SPCPhoneToId', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SRRAudio', 'DISPID_SVEBookmark', 'DISPID_SGRSTransitions',
    'SRTStandard', 'SPBOOKMARKOPTIONS', 'SPGRAMMARSTATE',
    'SECFIgnoreWidth', 'SINoise',
    'DISPID_SpeechGrammarRuleStateTransition', 'SRATopLevel',
    'SECFDefault', 'SDA_One_Trailing_Space',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SASFreeBufferSpace',
    'DISPID_SMSGetData'
]

_check_version('1.2.0', 1696960755.620371)
